...
//            NSDictionary *shengdict = arrData[i];
//            NSMutableDictionary *shengmutdic = [NSMutableDictionary dictionary];
//            shengmutdic[@"name"] = shengdict[@"v"];
//            NSArray *shengArr = shengdict[@"n"];
//            
//            NSMutableArray *shengMutarr = [NSMutableArray array];
//            for (int j = 0; j < shengArr.count; j++) {
//                NSDictionary *shidict = shengArr[j];
//                NSMutableDictionary *shimutdic = [NSMutableDictionary dictionary];
//                shimutdic[@"name"] = shidict[@"v"];
//                NSArray *shiArr = shidict[@"n"];
//                NSMutableArray *shiarr = [NSMutableArray array];
//                for (int n = 0; n < shiArr.count; n++) {
//                    NSDictionary *qudict = shiArr[n];
////                    NSMutableDictionary *qumutdic = [NSMutableDictionary dictionary];
////                    qumutdic[@"s"] = qudict[@"v"];
//                    [shiarr addObject:qudict[@"v"]];
//                }
//                shimutdic[@"area"] = shiarr;
//                [shengMutarr addObject:shimutdic];
//            }
//            shengmutdic[@"city"] = shengMutarr;
//            [arr addObject:shengmutdic];
//        }
//        NSDictionary *allDict = @{@"citylist" : arr};
//        NSString *josn = [allDict mj_JSONString];
//    
...
- (void)setupUI{
    ...
    [viewHeader setBackgroundColor:BaseColorBlue];
...
static NSInteger recordRowOfProvince = 0;//北京
