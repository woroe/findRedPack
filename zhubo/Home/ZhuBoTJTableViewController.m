...
@interface ZhuBoTJTableViewController ()<ZhuBoCellDelegate, ZhuBoDetailViewDelegate,FMGVideoPlayViewDelegate,ZYTagImageViewDelegate,JZLPhotoBrowserDelegate>{
...
@implementation ZhuBoTJTableViewController
...
- (void)loadData {
    ...
    params[@"BuildSowingType"] = @"FollowNews";
    params[@"Page"] = @(page);
