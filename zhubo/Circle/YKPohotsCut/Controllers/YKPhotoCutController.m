...
- (void)cutBtnClick
{
    if (_cutView) {
        ...
        _cutView = [[YKCutView alloc] initWithFrame:CGRectMake(0, 0, 200, 200)];
        _cutView.emptyView.userInteractionEnabled = NO;
        
        _cutView.center = CGPointMake(200, 200);
...
{
//    
//    if (_cutView.frame.size.width != _cutView.frame.size.height && _mainView.frame.size.width != _mainView.frame.size.height ) {
...
//        [self cutOkBtnClick];
//    }else if (_cutView ==nil) {
//        UIImage *image = _photoArr[0];
//        if (image.size.width > image.size.height) {
//            float width = image.size.height;
//            float height = image.size.height;
//            CGImageRef imageRef = nil;
//            imageRef = CGImageCreateWithImageInRect([image CGImage], CGRectMake(0, fabs(image.size.height - height) / 2, width, height));
...
//        if (self.delegate) {
//            [self.delegate getBackCutPhotos:arr];
//        }
//        [self backBtnClick];
//    }else{
//        if (self.delegate) {
